...
import 'package:mubclean/src/config/app_colors.dart'; // Importa tus colores
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final secondaryTextColor = isDarkMode ? AppColors.gray400 : AppColors.gray500;
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        preferredSize: const Size.fromHeight(kToolbarHeight + 16), // Altura un poco más grande
        child: Container(
          color: backgroundColor, // Fondo de la barra
          padding: const EdgeInsets.only(top: 16.0, left: 16.0, right: 16.0), // Padding personalizado
          child: AppBar(
            backgroundColor: Colors.transparent, // Transparente para usar el Container de fondo
            elevation: 0, // Sin sombra
            leading: const Icon(Icons.auto_awesome, color: AppColors.primary, size: 28), // Ícono de estrella
            title: Text(
              'Hola, Sofía',
              style: TextStyle(
                color: textColor,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(content: Text('Cotizar Ahora')),
                                  );
                                },
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        child: const Text('Ver Detalles', style: TextStyle(color: AppColors.primary, fontSize: 14)),
                      ),
                    ],
                  ),
                ),
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16.0),
              child: Column( // Usamos Column para que cada tarjeta ocupe el ancho completo
                children: [
            ...
            const SizedBox(height: 100), // Espacio para que la navegación inferior no cubra contenido
          ],
        ),
      ),
      ...
      bottomNavigationBar: Container(
        decoration: BoxDecoration(
          color: cardColor.withOpacity(0.9), // Fondo con opacidad y efecto blur
        ...
        child: BottomNavigationBar(
          backgroundColor: Colors.transparent, // Fondo transparente para usar el Container
          elevation: 0, // Sin sombra
  ...
  Widget _buildQuickAccessCard(
    ...
    return InkWell( // Hace que toda la tarjeta sea clickable
      onTap: onTap,
      borderRadius: BorderRadius.circular(12.0),
      child: Card(
        color: cardColor,
